...
import { FiGrid, FiAward, FiSettings, FiLogOut } from "react-icons/fi";
...
const navigation = [
  { name: "Skills", href: "/dashboard/developer/skills", icon: FiGrid },
  {
    name: "Endorsements",
    href: "/dashboard/developer/endorsements",
    icon: FiAward,
  },
  {
    name: "Settings",
...
export default function DeveloperSidebar({ profile }: DeveloperSidebarProps) {
